                  ...
                  builder: (context, state) {
                    ...
                    return Column(
                      ...
                      children: [
                        ...
                        SizedBox(
                          height: 400,
                          child: GeneralInformationPanel(product: product),
                        ),
                        Builder(
                          builder: (context) {
          ...
          children: [
            ...
            Text(
              ...
              style: context.responsive(
                ...
                lg: textTheme.titleMedium!.copyWith(
                  color: colorScheme.onSurfaceVariant,
                ),
...
class DetailsToolBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final textTheme = theme.textTheme;
    return SizedBox(
      height: context.responsive(45, lg: 45, xl: 55),
      child: Row(
          ...
          Container(
            ...
            child: IconButton(
              ...
              icon: SvgIcon(
                ...
                height: context.responsive(20, lg: 25, xl: 35),
